...
# DỮ LIỆU MÔN HỌC (DATA_DB) - Đã mở rộng
DATA_DB = {
    "Toán": {
        "Lớp 1": {
            "Kết nối tri thức": {
            ...
            "Chân trời sáng tạo": {
                "Chủ đề 1: Các số đến 10": [{"topic": "Các số 1, 2, 3, 4, 5", "periods": 3}, {"topic": "Số 0", "periods": 1}],
                "Chủ đề 2: Phép cộng trừ": [{"topic": "Phép cộng", "periods": 4}]
            },
            "Cánh Diều": {
        ...
        "Lớp 2": {
            "Kết nối tri thức": {
                ...
                "Chủ đề 2: Phép cộng trừ qua 10": [{"topic": "Bài 6: Phép cộng (có nhớ)", "periods": 3}]
            }
        },
        "Lớp 3": {
            "Kết nối tri thức": {
                "Chủ đề 1: Số và phép tính": [{"topic": "Bài 1: Ôn tập các số đến 1000", "periods": 2}, {"topic": "Bảng nhân 3, 4, 6", "periods": 3}],
                "Chủ đề 2: Hình học": [{"topic": "Hình tam giác, tứ giác", "periods": 2}]
            }
        },
        "Lớp 4": {
            "Kết nối tri thức": {
                "Chủ đề 1: Số tự nhiên": [{"topic": "Bài 1: Ôn tập các số đến 100 000", "periods": 1}, {"topic": "Bài 2: Các số có nhiều chữ số", "periods": 2}],
                "Chủ đề 2: Các phép tính số tự nhiên": [{"topic": "Bài 5: Phép cộng, phép trừ", "periods": 2}, {"topic": "Bài 6: Phép nhân, phép chia", "periods": 3}]
            },
            "Chân trời sáng tạo": {
                "Chủ đề 1: Ôn tập": [{"topic": "Biểu thức có chứa chữ", "periods": 2}]
            }
        },
        "Lớp 5": {
            "Kết nối tri thức": {
                "Chủ đề 1: Số thập phân": [{"topic": "Khái niệm số thập phân", "periods": 2}, {"topic": "Hàng của số thập phân", "periods": 1}],
                "Chủ đề 2: Các phép tính": [{"topic": "Cộng, trừ số thập phân", "periods": 3}]
            }
        }
    },
    "Tiếng Việt": {
        "Lớp 1": {
            "Kết nối tri thức": {
                "Chủ đề 1: Những bài học đầu tiên": [{"topic": "Bài 1: A, a", "periods": 2}, {"topic": "Bài 2: B, b, dấu huyền", "periods": 2}],
                "Chủ đề 2: Đi học": [{"topic": "Bài 6: O, o, dấu hỏi", "periods": 2}]
            }
        },
        "Lớp 4": {
            "Kết nối tri thức": {
                "Chủ điểm: Mỗi người một vẻ": [
                    ...
                    {"topic": "Viết: Đoạn văn kể chuyện", "periods": 2}
                ]
            }
        },
        "Lớp 5": {
            "Kết nối tri thức": {
                "Chủ điểm: Thế giới tuổi thơ": [{"topic": "Đọc: Thanh âm của gió", "periods": 2}, {"topic": "LTVC: Đại từ", "periods": 1}]
            }
        }
    },
    "Khoa học": {
        "Lớp 4": {
            "Kết nối tri thức": {
                "Chủ đề 1: Chất": [{"topic": "Bài 1: Tính chất của nước", "periods": 2}, {"topic": "Bài 2: Sự chuyển thể của nước", "periods": 2}],
                "Chủ đề 2: Năng lượng": [{"topic": "Bài 5: Ánh sáng và bóng tối", "periods": 2}]
            }
        },
        "Lớp 5": {
            "Kết nối tri thức": {
                "Chủ đề: Đất và Môi trường": [{"topic": "Đất và bảo vệ môi trường đất", "periods": 2}]
            }
        }
    },
    "Lịch sử & Địa lí": {
        "Lớp 4": {
            "Kết nối tri thức": {
                "Chủ đề 1: Địa phương em": [{"topic": "Bài 1: Làm quen với bản đồ", "periods": 2}, {"topic": "Bài 2: Thiên nhiên địa phương", "periods": 3}],
                "Chủ đề 2: Trung du miền núi Bắc Bộ": [{"topic": "Bài 3: Thiên nhiên vùng Trung du", "periods": 2}]
            }
        },
        "Lớp 5": {
            "Kết nối tri thức": {
                "Chủ đề: Đất nước và con người": [{"topic": "Vị trí địa lí Việt Nam", "periods": 2}]
            }
        }
    },
    "Tin học": {
        "Lớp 3": {
            "Kết nối tri thức": {
                "Chủ đề 1: Máy tính và em": [{"topic": "Thông tin và quyết định", "periods": 1}, {"topic": "Các bộ phận máy tính", "periods": 1}]
            }
        },
        "Lớp 4": {
            "Kết nối tri thức": {
                "Chủ đề: Máy tính và em": [{"topic": "Phần cứng và phần mềm", "periods": 1}]
            }
        },
        "Lớp 5": {
             "Kết nối tri thức": {
                "Chủ đề: Thế giới số": [{"topic": "Thư điện tử", "periods": 2}]
            }
        }
    },
    "Công nghệ": {
        "Lớp 3": {
            "Kết nối tri thức": {
                "Chủ đề 1: Công nghệ và đời sống": [{"topic": "Tự nhiên và Công nghệ", "periods": 1}, {"topic": "Sử dụng đèn học", "periods": 1}]
            }
        },
        "Lớp 4": {
             "Kết nối tri thức": {
                "Chủ đề: Hoa và cây cảnh": [{"topic": "Lợi ích của hoa và cây cảnh", "periods": 1}]
            }
        }
    },
    "Tiếng Anh": {
        "Lớp 3": {
            "Global Success": {
                "Unit 1: Hello": [{"topic": "Lesson 1", "periods": 1}, {"topic": "Lesson 2", "periods": 1}],
                "Unit 2: Our Names": [{"topic": "Lesson 1", "periods": 1}]
            }
        },
        "Lớp 4": {
            "Global Success": {
                "Unit 1: My Friends": [{"topic": "Lesson 1", "periods": 1}]
            }
        },
        "Lớp 5": {
             "Global Success": {
                "Unit 1: All about me": [{"topic": "Lesson 1", "periods": 1}]
            }
        }
    }
}
...
# ==========================================
# 2. HÀM XỬ LÝ WORD (GỘP Ô CHUẨN PDF)
# ==========================================
st.markdown("""
<style>
...
def create_docx_advanced(school, exam, info, body, key, matrix_df, total_score_calc):
    ...
    # --- HEADER ROW 1 (Gộp ô lớn: Trắc nghiệm / Tự luận) ---
    c_tn = table.cell(0, 6)
    ...
    # --- HEADER ROW 2 (Gộp ô loại câu hỏi) ---
    types_map = [
        (6, 8, "Nhiều lựa chọn"),
        (9, 11, "Đúng - Sai"),
        (12, 14, "Nối cột"),
    ...
    # --- HEADER ROW 3 (Mức độ: Biết - Hiểu - VD) ---
    ...
    # --- FILL DATA (Dữ liệu từ DataFrame) ---
...
def call_ai_advanced(api_key, matrix_df, info):
    ...
    # Tạo mô tả chi tiết cho AI
    ai_prompt_data = ""
    for idx, row in matrix_df.iterrows():
        ai_prompt_data += f"\n- Chủ đề: {row['Chủ đề']} ({row['Nội dung']}):\n"
        # Chỉ liệt kê các loại câu hỏi có số lượng > 0
        if row['MCQ_B'] > 0: ai_prompt_data += f"  + Trắc nghiệm 4 lựa chọn (Biết): {row['MCQ_B']} câu\n"
        if row['MCQ_H'] > 0: ai_prompt_data += f"  + Trắc nghiệm 4 lựa chọn (Hiểu): {row['MCQ_H']} câu\n"
        if row['MCQ_V'] > 0: ai_prompt_data += f"  + Trắc nghiệm 4 lựa chọn (Vận dụng): {row['MCQ_V']} câu\n"
    ...
    4. Dạng Điền khuyết: Đoạn văn hoặc câu có chỗ trống.
...
# Khởi tạo DataFrame ma trận với đầy đủ các cột
    ...
    for idx, s_name in enumerate(valid_subs):
        ...
        with c_sub[idx % 4]:
            if st.button(f"{meta['icon']} {s_name}", key=s_name, use_container_width=True):
                ...
                # Reset Ma trận khi chọn môn mới
                cols = ["TT", "Chủ đề", "Nội dung", "Số tiết", "MCQ_B", "MCQ_H", "MCQ_V", "TF_B", "TF_H", "TF_V", "MAT_B", "MAT_H", "MAT_V", "FILL_B", "FILL_H", "FILL_V", "TL_B", "TL_H", "TL_V"]
                st.session_state.matrix_df = pd.DataFrame(columns=cols)
...
# --- BƯỚC 2: NHẬP LIỆU MA TRẬN ---
                ...
                if sel_lessons:
                    ...
                    for l in sel_lessons:
                        ...
                        row_data = {
                            ...
                            # Khởi tạo các ô nhập liệu bằng 0
    ...
    with right:
        ...
        if not st.session_state.matrix_df.empty:
            # Cấu hình hiển thị cột cho gọn gàng
            col_cfg = {
                ...
                if not api_key:
                    ...
                    with st.spinner("Đang xử lý..."):
                        ...
                        if body:
                            ...
                            st.download_button("📥 Tải file DOCX (Chuẩn mẫu PDF)", f, "De_Kiem_Tra.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document")
                        else:
                            st.error(key)
        else:
