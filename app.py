        ...
        if uploaded and st.button("🚀 TẠO ĐỀ THI NGAY", type="primary", key="t1_btn"):
            ...
            if content:
                with st.spinner("Đang phân tích ma trận và tạo đề từ nguồn GDPT 2018..."):
                    ...
                    2. Phân tích nội dung file để xác định bộ sách giáo khoa (Chân trời sáng tạo, Kết nối tri thức, Cùng khám phá, v.v.) và soạn đề sát với ngữ liệu bộ sách đó.
                    ...
                    4. Sắp xếp câu hỏi từ Mức 1 đến Mức 3.
                    """
