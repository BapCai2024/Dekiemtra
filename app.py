    ...
    "Lớp 4": {
        ...
        "Khoa học": {
            "Học kỳ I": [
                ...
                {"Chủ đề": "Năng lượng", "Bài học": "Bài 8: Ánh sáng và sự truyền ánh sáng; Bài 9: Vai trò của ánh sáng; Bài 10: Âm thanh và sự truyền âm thanh; Bài 11: Âm thanh trong cuộc sống; Bài 12: Nhiệt độ và sự truyền nhiệt; Bài 13: Vật dẫn nhiệt tốt, vật dẫn nhiệt kém; Bài 14: Ôn tập chủ đề Năng lượng"},
                {"Chủ đề": "Thực vật và động vật", "Bài học": "Bài 15: Thực vật cần gì để sống?; Bài 16: Động vật cần gì để sống?; Bài 17: Chăm sóc cây trồng, vật nuôi; Bài 18: Ôn tập chủ đề Thực vật và động vật"}
            ],
            "Học kỳ II": [
                {"Chủ đề": "Nấm", "Bài học": "Bài 19: Đặc điểm chung của nấm; Bài 20: Nấm ăn và nấm trong chế biến thực phẩm; Bài 21: Nấm gây hỏng thức ăn và nấm độc; Bài 22: Ôn tập chủ đề Nấm"},
                {"Chủ đề": "Con người và sức khoẻ", "Bài học": "Bài 23: Vai trò của chất dinh dưỡng đối với cơ thể; Bài 24: Chế độ ăn uống cân bằng; Bài 25: Một số bệnh liên quan đến dinh dưỡng; Bài 26: Thực phẩm an toàn; Bài 27: Phòng tránh đuối nước; Bài 28: Ôn tập chủ đề Con người và sức khoẻ"},
                {"Chủ đề": "Sinh vật và môi trường", "Bài học": "Bài 29: Chuỗi thức ăn trong tự nhiên; Bài 30: Vai trò của thực vật trong chuỗi thức ăn; Bài 31: Ôn tập chủ đề Sinh vật và môi trường"}
            ]
        },
        "Tin học": {
            "Học kỳ I": [
...
def extract_periods(lesson_name):
    # Trích xuất số tiết từ tên bài học nếu có định dạng (3 tiết)
...
def main():
    ...
    with tab2:
        ...
        if not raw_data:
            ...
            with col_a:
                # Xử lý Dropdown Học kỳ (Vì dữ liệu giờ đã phân theo học kỳ)
            ...
            with col_b:
                ...
                # Input YCCĐ (Cho phép người dùng nhập nếu thiếu, hoặc lấy từ dữ liệu nếu có)
                yccd_input = st.text_area("Yêu cầu cần đạt (YCCĐ):", value="Nắm vững kiến thức cơ bản và vận dụng giải bài tập.", height=68, key="t2_yccd")
            ...
            if len(st.session_state.exam_list) > 0:
                ...
                # TẠO LẠI BẢNG THỐNG KÊ SỐ CÂU THEO YÊU CẦU 3 (Tab 2)
    ...
    with tab3:
        ...
        if len(st.session_state.exam_list) == 0:
            ...
            # Cập nhật ngược lại session_state nếu có thay đổi quan trọng (logic đơn giản)
            if st.button("💾 Cập nhật thay đổi từ Ma trận"):
                # Lưu ý: Việc cập nhật ngược này chỉ mang tính tương đối vì cấu trúc exam_list phức tạp hơn
                # Ở đây ta cập nhật lại các trường thông tin cơ bản vào exam_list
